...
const projects = [
  {
    ...
    summary:
      'Redesign completo della landing con focus su performance e lead generation.',
  ...
  },
  {
    ...
    category: 'Gestionale',
    summary:
      'Mini gestionale per appuntamenti, storico pazienti e promemoria automatici.',
  ...
  },
  {
    ...
    summary:
      'Assistente AI per supporto pre-vendita con routing ticket e FAQ dinamiche.',
  ...
  },
  {
    ...
    category: 'Dashboard',
    summary:
      'Dashboard KPI in tempo reale per tracking spedizioni e SLA del team operativo.',
  ...
  },
  {
    ...
    category: 'UI/UX',
    summary:
      'Refactor dei flussi onboarding con prototipi testati e design system modulare.',
    result: '-34% drop-off',
  ...
  },
  {
    ...
    category: 'SEO + CRO',
    summary:
      'Ottimizzazione tecnica e contenuti cluster per aumentare traffico organico.',
  ...
  },
  {
    ...
    summary:
      'Pannello interno per task, scadenze e marginalita commesse in un unico flusso.',
  ...
  },
  {
    ...
    category: 'Web App',
    summary:
      'Portale analitico multi-tenant con autenticazione e viste personalizzate.',
    ...
    >
      <div className={styles.header}>
        ...
        <p className={styles.sub}>
          Questa e una preview della sezione portfolio: layout pronto,
          animazioni attive e spazio perfetto per inserire i tuoi case study
          completi.
        </p>
      </div>
